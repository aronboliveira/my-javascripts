...
import FormDateHourMin from "./component";
registerBlockType("bootstrap/datehourmin", {
  ...
  example: {
    ...
    description: "Preview do Campo de Data com Horário a Ocorrer",
    innerBlocks: [],
  },
